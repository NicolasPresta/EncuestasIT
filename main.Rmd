...
sprintf("Cantidad de renglones inconsistentes: %d", length(renglonesInconsistentes)) 

# Cantidad de renglones consistentes:
sprintf("Cantidad de renglones consistentes: %d", length(renglonesConsistentes)) 

# Cantidad de renglones total:
sprintf("Cantidad de renglones total: %d", length(txtdata)) 
